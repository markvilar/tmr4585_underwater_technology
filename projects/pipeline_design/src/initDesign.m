...
seg1 = PipeSegment(kp000, kp001, 2, Di, ovality, material, tCorr, ...
    rhoCorr, kCorr, tConcMin, rhoConc, kConc);
seg2 = PipeSegment(kp001, kp090, 1, Di, ovality, material, tCorr, ...
    rhoCorr, kCorr, tConcMin, rhoConc, kConc);
seg3 = PipeSegment(kp090, kp100, 1, Di, ovality, material, tCorr, ...
    rhoCorr, kCorr, tConcMin, rhoConc, kConc);
seg4 = PipeSegment(kp100, kp105, 2, Di, ovality, material, tCorr, ...
    rhoCorr, kCorr, tConcMin, rhoConc, kConc);
seg5 = PipeSegment(kp105, kp115, 2, Di, ovality, material, tCorr, ...
    rhoCorr, kCorr, tConcMin, rhoConc, kConc);
seg6 = PipeSegment(kp115, kp150, 2, Di, ovality, material, tCorr, ...
    rhoCorr, kCorr, tConcMin, rhoConc, kConc);
